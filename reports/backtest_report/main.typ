...
#show: report-theme.with(
  title: "Advanced Backtest Report",
  author: "Manus AI",
  rhythm: "report",
  running-header: true,
)
...
#page(margin: (top: 30%, x: 2.2cm), numbering: none, header: none)[
  ...
  #align(center)[
    #text(size: 26pt, weight: "bold", fill: report-accent)[Advanced Backtest Report]
    #v(0.5em)
    #text(size: 14pt, fill: luma(80))[Generated from local paper-trading research]
    #v(2em)
